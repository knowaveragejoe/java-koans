...
public class AboutPrimitives {
    ...
    public void primitivesOfTypeIntHaveAnObjectTypeInteger() {
        Object number = 1;
        // assertEquals(getType(number), "class java.lang.Integer");
    ...
    public void primitivesOfTypeLongHaveAnObjectTypeLong() {
        Object number = 1L;
        // assertEquals(getType(number), "class java.lang.Long");
    }
    ...
    public void primitivesOfTypeByteHaveAnObjectTypeByte() {
        ...
        // assertEquals(getType(number), "class java.lang.Byte");
    }

    @Koan
    public void bytesHaveASmallerRangeThanShorts() {
        // assertEquals(Byte.MIN_VALUE, "-128");
        // assertEquals(Byte.MAX_VALUE, "128");
    ...
    public void primitivesOfTypeCharHaveAnObjectTypeCharacter() {
        ...
        // assertEquals(getType(number), "class java.lang.Character");
    }
    ...
    public void primitivesOfTypeDoubleHaveAnObjectTypeDouble() {
        Object number = 1.0;
        // assertEquals(getType(number), "class java.lang.Double");
    }
    ...
    public void primitivesOfTypeFloatHaveAnObjectTypeFloat() {
        Object number = 1f;
        // assertEquals(getType(number), "class java.lang.Float");
    }
